...
class ParseResultTest {
    ...
    void whenParsingFailsThenWeGetProblemsAndABadResult() {
        ...
        assertThat(problem.getMessage())
                .isEqualTo(
                        "Parse error. Found \"{\", expected one of  \"enum\" \"exports\" \"module\" \"open\" \"opens\" \"permits\" \"provides\" \"record\" \"requires\" \"sealed\" \"strictfp\" \"to\" \"transitive\" \"uses\" \"value\" \"when\" \"with\" \"yield\" <IDENTIFIER>");
